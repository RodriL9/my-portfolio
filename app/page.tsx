...
const NAV_ITEMS = ["About","Experience", "Projects", "Contact", "Resume"];

const PROJECTS = [
  {
    id: 1,
    title: "Daily To-Do List",
    description: "A Daily To-Do list application built with React, featuring a clean UI that enables you to add and delete tasks seamlessly while keeping track of your daily activities.",
    tech: ["React","JavaScript XML", "HTML", "CSS"],
    videoUrl: "https://www.youtube.com/embed/mXCR885e828?si=iW5V7QJX6aflswXL",
  ...
  },
  {
    ...
    tech: ["Python", "PHP", "SSH" ,"BootStrap"],
    videoUrl: "https://www.youtube.com/embed/CY8whTlSRIw?si=uhHp1KeA9c5gOZdG",
       ...
       <div className="about-grid">
          <div className="about-photo-wrap">
            <div className="about-photo">
             <img src="/rodri.jpg" alt="Rodrigo" style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
             <img src="https://static.wixstatic.com/media/7383ad_c9a2ed5d32704d6b81504a4175fa440c~mv2.png/v1/fill/w_1500,h_1500,al_c/Kean%20College.png" alt="Kean University" style={{ width: '50%', height: '100%', objectFit: 'contain' }} />
            </div>
          ...
          <p>
           Hey! I'm <strong>Rodrigo Leites-Mena</strong>, a junior Computer Science student at <strong>Kean University</strong>. I have a deep curiosity for how things work under the hood, from the hardware level all the way up to the applications people use every day.
          </p>
            <p>
              I've worked with low-level systems programming in C, built and debugged inside Linux environments, and dived deep into computer architecture and operating systems. Whether it's implementing a cache simulator from scratch or modifying an xv6 kernel scheduler, I thrive on problems that require real technical thinking. I love the process of breaking down a challenge, designing a solution, and figuring out exactly how to bring it to life.
            </p>
            <p>
              Beyond the screen, I'm passionate about sports and staying active. The same competitive drive I bring to sports is what pushes me to keep growing as a developer and an individual. I'm always chasing the next idea that makes me think differently, and I genuinely get excited about finding elegant solutions to hard problems.
            </p>
            <p>
              Some related skills and technologies I have experience with include: 
            </p>
            <div className="skills-grid">
              {["React", "Next.js", "TypeScript", "PostgreSQL", "HTML/CSS", "C", "Java", "Python", "Linux","Microsoft Azure", "Git", "VS Code"].map(s => (
      ...
      <section id="experience" style={{ background: "var(--bg)" }}>
        ...
        <div className="experience-card">
          <div className="experience-header">
            <div>
              <h3 className="experience-title">BMW Product Specialist</h3>
              <p className="experience-company">Open Road BMW — Edison, NJ</p>
            </div>
            <span className="experience-date">Aug 2020 – Present</span>
          </div>
          <ul className="experience-list">
            <li>Diagnose and resolve complex technical issues, troubleshooting software and hardware efficiently.</li>
            <li>Acquire in-depth knowledge of BMW vehicles, including onboard computer systems and digital dashboards.</li>
            <li>Provide training and guidance on BMW operating systems and infotainment technology.</li>
            <li>Facilitate technical demonstrations using hands-on and virtual tools.</li>
            <li>Actively participate in ongoing technical education programs to stay current with BMW technologies.</li>
          </ul>
        </div>
      </section>
